...
const translations = {
  es: {
    ...
    labDescription: 'Producción de modelos 3D para experiencias de Realidad Virtual y desarrollo de simuladores VR.',
    lab1: 'Producción de modelos 3D para experiencias de Realidad Virtual en Oculus Quest 2.',
    lab2: 'Desarrollo de juegos con Unity utilizando C# y Unreal Engine 4 con Visual Scripting.',
    lab3: 'Desarrollo de simuladores VR para la Empresa Provincial de Energía (EPE).',
    lab4: 'Desarrollo de simuladores de manejo bajo los efectos del alcohol para la Empresa Provincial de Seguridad Vial desarrollado en Unreal Engine 4.',
  ...
  en: {
    ...
    labPosition: 'Junior Technical Artist | Unity/Unreal Developer',
    labDescription: 'Production of 3D models for Virtual Reality experiences and development of VR simulators.',
    lab1: 'Production of 3D models for Virtual Reality experiences on Oculus Quest 2.',
    lab2: 'Game development with Unity using C# and Unreal Engine 4 using Visual Scripting.',
    lab3: 'Development of VR simulators for the Provincial Energy Company (EPE).',
    lab4: 'Development of driving simulators under the effects of alcohol for the Provincial Road Safety Company developed in Unreal Engine 4.',
